...
public class CanadaActivity extends AppCompatActivity {
    ...
    private AppCompatTextView westJet, mcCain, timHortons, shoppers, bombardier, saputo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        westJet.setOnClickListener(v -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwj-zfHXgOP1AhWrg_0HHYvABsYQFnoECAYQAQ&url=https%3A%2F%2Fwww.westjet.com%2Fen-ca%2Fwho-we-are&usg=AOvVaw0wHqtzGhhbF2sV0gmRA0qo"))));

        mcCain = findViewById(R.id.mccain);
        mcCain.setOnClickListener(v -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwj_1LetgeP1AhWKHxQKHZIgAhkQFnoECAoQAw&url=https%3A%2F%2Fwww.mccainindia.com%2Fabout-us&usg=AOvVaw1dwRoklOXdpLAqqToLck1E"))));

        timHortons = findViewById(R.id.hortons);
        timHortons.setOnClickListener(v -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjY6ffkgeP1AhUXjhQKHWi0BRkQFnoECE4QAQ&url=https%3A%2F%2Fwww.thecanadianencyclopedia.ca%2Fen%2Farticle%2Ftim-hortons&usg=AOvVaw3rb7Hos-cKdIEytzdj-YMb"))));

        shoppers = findViewById(R.id.shoppers);
        shoppers.setOnClickListener(v -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwj6_86oguP1AhWRAmMBHR4yDxkQFnoECDMQAQ&url=https%3A%2F%2Fwww.shoppersfood.com%2Fabout.html&usg=AOvVaw19VpJ55yI7ZUH5wJ745CNp"))));

        bombardier = findViewById(R.id.bombardier_inc);
        bombardier.setOnClickListener(v -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjMy7TIg-P1AhWI2hQKHRqBCBkQFnoECFsQAQ&url=https%3A%2F%2Fwww.britannica.com%2Ftopic%2FBombardier-Inc&usg=AOvVaw0GeKMETHQxtT2rHVhdzkAf"))));

        saputo = findViewById(R.id.saputo);
        saputo.setOnClickListener(v -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwj6tL6JhOP1AhUWDmMBHQr7ARkQFnoECF8QAQ&url=https%3A%2F%2Fca.indeed.com%2Fcmp%2FSaputo%2Fabout&usg=AOvVaw3umkfDn4mdBKzZjlYM4-l7"))));
